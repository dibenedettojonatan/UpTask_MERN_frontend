  ...
  return (
    <div className="border-b p-5 flex justify-between items-center">
        ...
        <div className="flex flex-col lg:flex-row gap-2">
            { admin && (
                <button
                    className="bg-indigo-600 px-4 py-3 rounded-md text-white uppercase font-bold text-sm"
            ...
            { admin && (
                <button
                    ...
                    className="bg-red-600 px-4 py-3 rounded-md text-white uppercase font-bold text-sm"
